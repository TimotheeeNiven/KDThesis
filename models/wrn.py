...
__all__ = ['wrn', 'wrn_16_1', 'wrn_16_2', 'wrn_40_1', 'wrn_40_2', 'wrn_40_4', 'wide_resnet101_2']
...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0):
        ...
        if (depth - 4) % 6 != 0:
    	    print(f"Warning: depth {depth} does not follow the 6n+4 rule. Proceeding anyway.")
        n = (depth - 4) // 6
        block = BasicBlock
...
def wrn_20_4(**kwargs):
    model = WideResNet(depth=20, widen_factor=4, **kwargs)
    return model
...
def wrn_16_0_5(**kwargs):
    model = WideResNet(depth=16, widen_factor=0.5, **kwargs)
    return model
...
def wide_resnet101_2(**kwargs):
    """
    Constructs a WideResNet-101-2 model.
    """
