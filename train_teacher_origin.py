...
def parse_option():
    ...
    parser.add_argument('--model', type=str, default='resnet110',
				 ...
				 'resnext50_32x4d','resnext101_32x8d','pyramidnet272', 'pyramidnet110',
                                 ...
                                 'vitb16','efficientnet_v2m','densenet121','densenet169','convnexttiny'])

    parser.add_argument('--dataset', type=str, default='cifar100', choices=['cifar100','speechcommands', 'imagenet', 'squad'], help='dataset')
